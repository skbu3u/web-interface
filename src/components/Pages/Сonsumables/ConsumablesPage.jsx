...
import { API_CONSUM_GET } from '../../Apiconst/apiConstants';
      ...
      <div className="flex flex-col">
        <div className="px-4 md:px-10 py-4 md:py-7 bg-gray-100 rounded-tl-lg rounded-tr-lg">
          <div className="sm:flex items-center justify-between">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Расходные материалы</p>
            <div>
              <button
                type="button"
                  ...
                  {userdata.map((userdata) => (
                    <tr key={userdata.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{userdata.compatibility}</div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <FcDeleteDatabase
                          className="h-6 w-6 contrast-100 hover:contrast-50"
                          aria-hidden="true"
                        />
                      </td>
                    </tr>

...
<div className="py-2">
            <div className="max-w-sm bg-white shadow rounded p-6">
                <div className="flex items-end">
                    <p className="text-xl font-semibold leading-5 text-gray-800">Активность</p>
                </div>
                <div className="mt-4 flex">
                    ...
                    <div className="pl-2">
                        <p className="text-sm font-semibold leading-normal text-gray-800">Кирилл Сарычев</p>
                        <p className="text-xs leading-3 text-gray-500 pt-1">2 часа назад</p>
                        <p className="pt-4 text-sm leading-4 text-gray-600">
                            Сделал изменения  в <span className="text-indigo-700">styleguide.fig</span>
                        </p>
                    </div>
                </div>
                <div className="mt-6 flex">
                    ...
                    <div className="pl-3">
                        <p className="text-sm font-semibold leading-normal text-gray-800">Анфиса Чехова</p>
                        <p className="text-xs leading-3 text-gray-500 pt-1">5 часов назад</p>
                        <p className="pt-4 text-sm leading-4 text-gray-600">
                            Отправила поставщику файлы на  <span className="text-indigo-700">jill@astro.com </span>
                        </p>
                    </div>
                </div>
                <div className="mt-6 flex">
                    ...
                    <div className="pl-3">
                        <p className="text-sm font-semibold leading-normal text-gray-800">Борис Зеленский</p>
                        <p className="text-xs leading-3 text-gray-500 pt-1">8 часов назад</p>
                        <p className="pt-4 text-sm leading-4 text-gray-600">
                            Накладная  <span className="text-indigo-700">#18293</span> была 
                            <br />
                            отрправлена.Ждет ответа
                        </p>
                    </div>
                </div>
                <div className="mt-6 flex">
                    ...
                    <div className="pl-3">
                        <p className="text-sm font-semibold leading-normal text-gray-800">Джилиан Андерсен</p>
                        <p className="text-xs leading-3 text-gray-500 pt-1">8 часов назад</p>
                        <div className="py-4 flex items-center">
                            ...
                            <p className="text-xs leading-6 pl-2 text-indigo-700">Отчет.docx</p>
                        </div>
                    </div>
                </div>
            </div>

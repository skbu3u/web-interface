                ...
                <div className="rounded shadow bg-white dark:bg-gray-800 pl-6 pr-12">
                    <div className="md:flex items-center justify-between ">
                        <div className="flex items-center pr-2">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">35</p>
                        ...
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">8549</p>
                        ...
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">14</p>
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Документов</p>
                            </div>
                        </div>
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                ...
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Выручка</p>
                            </div>
                        </div>
                    </div>
                </div>

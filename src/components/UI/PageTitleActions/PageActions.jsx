...
export default function PageActions() {
  return (
    <>
        <div className="border-b border-gray-200 pt-24 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
        <div className="flex-1 min-w-0">
        <h1 className="text-lg font-medium leading-6 text-gray-900 sm:truncate">Главный экран</h1>
        </div>
